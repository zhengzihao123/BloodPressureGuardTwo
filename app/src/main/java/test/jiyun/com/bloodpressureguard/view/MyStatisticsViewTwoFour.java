...
public class MyStatisticsViewTwoFour extends View{
    //-------------View相关-------------
    //View自身的宽和高
    private int mHeight;
    private int mWidth;
    ...
    private String[] xStr = new String[]{"2017年1月", "4月", "7月", "10月", "12月"};
    private String[] yStr = new String[]{" ", "40", "80", "120", "160", "200"};
    private String str = "每年血压统计表";
    ...
    public MyStatisticsViewTwoFour(Context context) {
        super(context);
    }

    public MyStatisticsViewTwoFour(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public MyStatisticsViewTwoFour(Context context, AttributeSet attrs, int defStyleAttr) {
...
//            float position = -(yValue[i]/40*ySize);
            ...
            float positiona = ((xjj[i]-1)*xSize/3);
            //画黑点
    ...
    private void drawLineA(Canvas canvas) {
        for (int i = 0; i < yValuea.length; i++) {
            ...
            Log.d("MyStatisticsViewTwoFour", "xjj[i]:" + xjj[i]);
            float positiona = ((xjj[i]-1)*xSize/3);
            //画黑点
