    ...
    public void setTags(List<String> tags) {
        if (tags != null) {
            ...
            for (int i = 0; i < mTags.size(); i++) {
                ...
                MarginLayoutParams lp = new MarginLayoutParams(MarginLayoutParams.WRAP_CONTENT, 100);
                lp.setMargins(15, 15, 15, 15);
                tv.setTag(i);
//				lp.width = MarginLayoutParams.WRAP_CONTENT;
//				lp.height = MarginLayoutParams.WRAP_CONTENT;
                tv.setLayoutParams(lp);
                tv.setBackgroundResource(R.drawable.text_flag_01);
                /*
...
//				lp.height = MarginLayoutParams.WRAP_CONTENT;
            ...
            tv1.setBackgroundResource(R.drawable.add_questin_img);
